...
import { Server, ShoppingBag, Shield, Zap } from 'lucide-react';

const NixoNode: React.FC = () => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      <div className="flex justify-center mb-8">
        <div className="relative w-48 h-48 md:w-64 md:h-64">
          <motion.div
            ...
            animate={{ 
              boxShadow: [
                "0 0 0 0px rgba(60,205,58,0.4)",
                "0 0 0 20px rgba(60,205,58,0)", 
                "0 0 0 0px rgba(60,205,58,0.4)"
              ]
            }}
            transition={{ 
